  ...
  return (
    <div className="p-3 flex flex-col items-center justify-center">
      ...
      <div className="w-full flex items-center justify-between flex-col mt-3">
        ...
        <div className="border-t border-gray-600 p-2 w-full mt-4">
              ...
              <div className="flex items-center justify-center gap-2">
                <div className="flex items-center justify-center gap-2">
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    class="size-6 text-white hover:opacity-70 cursor-pointer"
                  >
                    <path
                      strokeLinecap="round"
                ...
                <Button variant="text" className="text-gray-600 font-medium">
                  Phản hồi
                </Button>
              </div>
              <div></div>
